(() => {
  ...
  // src/core/di/utils/provider.ts
  function isClassProvider(provider) {
    return provider.useClass !== void 0;
  }
  ...
  ***************************************************************************** */
  ...
  // src/core/di/core/injection-token.ts
  var InjectionToken = class {
    constructor(injectionIdentifier, options) {
  ...
  var Injector = class {
    ...
    getInjectedParams(target) {
      ...
      return argTypes.map((argType, index) => {
        ...
        const actualToken = overrideToken === void 0 ? argType : overrideToken;
  ...
  var injector = Injector.create([
    {provide: MyEasyState, useClass: MyEasyState}
  ]);
  var MyEasyElement = class extends EasyElement {
    constructor() {
      super(...arguments);
      this.state = injector.get(MyEasyState);
    }
    connectedCallback() {
      this.bind({title: "Usu\xE1rio"});
      ...
      wait(2)(() => {
        ...
        wait(2)(() => {
          this.state.setEmail("guiseek@gmail.com");
        });
      });
    }
  };
